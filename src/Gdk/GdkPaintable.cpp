...
/**
 * public function compute_concrete_size(float $specified_width, float $specified_height, float
 * $default_width, float $default_height): array Applies the sizing algorithm outlined in the CSS
 * Image spec to the given $paintable.
 *
