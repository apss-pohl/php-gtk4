...
/*
 * Gtk4\WebKitSnapshotOptions - Enum values used to specify options when taking a snapshot from a…
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitSnapshotOptions
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(WebKitSnapshotOptions::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>WebKitSnapshotOptions</b>\n" . implode("\n", $rows));
        return $label;
    },
);
