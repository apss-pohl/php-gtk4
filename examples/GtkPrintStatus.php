...
/*
 * Gtk4\GtkPrintStatus - The status gives a rough indication of the completion of a running print…
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkPrintStatus
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            GtkPrintStatus::cases(),
        );
        $label->set_markup("<b>GtkPrintStatus</b>\n" . implode("\n", $rows));
        return $label;
    },
);
