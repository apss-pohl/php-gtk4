...
/*
 * Gtk4\WebKitUserStyleLevel - Specifies how to treat an user style sheet.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitUserStyleLevel
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitUserStyleLevel::cases(),
        );
        $label->set_markup("<b>WebKitUserStyleLevel</b>\n" . implode("\n", $rows));
        return $label;
    },
);
