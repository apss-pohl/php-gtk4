...
/*
 * Gtk4\PangoScript - The PangoScript enumeration identifies different writing systems.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php PangoScript
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $label->set_markup("<b>PangoScript</b>\n" . implode("\n", $rows));
        return $label;
    },
);
