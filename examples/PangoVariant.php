...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\PangoVariant;

/*
 * Gtk4\PangoVariant - An enumeration specifying capitalization variant of the font.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php PangoVariant
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $label->set_markup("<b>PangoVariant</b>\n" . implode("\n", $rows));
        return $label;
    },
);
