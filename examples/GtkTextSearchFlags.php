...
/*
 * Gtk4\GtkTextSearchFlags - Flags affecting how a search is done.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkTextSearchFlags
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(GtkTextSearchFlags::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>GtkTextSearchFlags</b>\n" . implode("\n", $rows));
        return $label;
    },
);
