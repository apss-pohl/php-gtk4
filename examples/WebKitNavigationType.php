...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitNavigationType;

/*
 * Gtk4\WebKitNavigationType - Enum values used to denote the various navigation types.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitNavigationType
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitNavigationType::cases(),
        );
        $label->set_markup("<b>WebKitNavigationType</b>\n" . implode("\n", $rows));
        return $label;
    },
);
