...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\PangoLayoutDeserializeFlags;

/*
 * Gtk4\PangoLayoutDeserializeFlags
 ...
 * 'Generated' section.
 *
 *   bin/php-gtk4 examples/demo.php PangoLayoutDeserializeFlags
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(PangoLayoutDeserializeFlags::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>PangoLayoutDeserializeFlags</b>\n" . implode("\n", $rows));
        return $label;
    },
);
