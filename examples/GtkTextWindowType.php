...
/*
 * Gtk4\GtkTextWindowType - Used to reference the parts of GtkTextView.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkTextWindowType
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            GtkTextWindowType::cases(),
        );
        $label->set_markup("<b>GtkTextWindowType</b>\n" . implode("\n", $rows));
        return $label;
    },
);
