...
/*
 * Gtk4\PangoStyle - An enumeration specifying the various slant styles possible for a font.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php PangoStyle
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $label->set_markup("<b>PangoStyle</b>\n" . implode("\n", $rows));
        return $label;
    },
);
