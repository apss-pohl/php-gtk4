...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitDownloadError;

/*
 * Gtk4\WebKitDownloadError - Enum values used to denote the various download errors.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitDownloadError
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitDownloadError::cases(),
        );
        $label->set_markup("<b>WebKitDownloadError</b>\n" . implode("\n", $rows));
        return $label;
    },
);
