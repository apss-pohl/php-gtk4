 ...
 *
 *   bin/php-gtk4 examples/demo.php GdkRectangle
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $area = Demo::canvas(420, 300, static function (
            ...
            $rectA = sprintf('$a = %d,%d %dx%d', $a->x, $a->y, $a->width, $a->height);
            Demo::text($cr, 14, 262, $rectA, Demo::ACCENT, 12);
        ...
        Demo::status(sprintf('equal(clone) = %s', $a->equal(clone $a) ? 'true' : 'false'));
