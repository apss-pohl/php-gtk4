...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitUserContentFilterError;

/*
 * Gtk4\WebKitUserContentFilterError - Errors that can occur while compiling content filters.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitUserContentFilterError
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitUserContentFilterError::cases(),
        );
        $label->set_markup("<b>WebKitUserContentFilterError</b>\n" . implode("\n", $rows));
        return $label;
    },
);
