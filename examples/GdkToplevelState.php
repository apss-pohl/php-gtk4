 ...
 * 'Generated' section.
 *
 *   bin/php-gtk4 examples/demo.php GdkToplevelState
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(GdkToplevelState::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>GdkToplevelState</b>\n" . implode("\n", $rows));
        return $label;
    },
);
