...
/*
 * Gtk4\GtkPrintOperationAction - Determines what action the print operation should perform.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkPrintOperationAction
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            GtkPrintOperationAction::cases(),
        );
        $label->set_markup("<b>GtkPrintOperationAction</b>\n" . implode("\n", $rows));
        return $label;
    },
);
