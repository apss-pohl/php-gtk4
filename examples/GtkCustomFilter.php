 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkCustomFilter
 */
...
return Demo::page(
    'GtkCustomFilter',
    'a GtkFilter whose predicate is a PHP callable',
    function (GtkWindow $win): GtkWidget {
        ...
        /** @var list<array{string, ?callable(GObject): bool}> $predicates */
        $predicates = [
            ['born in the 20th century', static fn(GObject $item): bool => Demo::born($item) >= 1900],
            ['name contains "a" twice', static fn(GObject $item): bool
            => substr_count(strtolower(Demo::name($item)), 'a') >= 2],
            ['born before 1915', static fn(GObject $item): bool => Demo::born($item) < 1915],
