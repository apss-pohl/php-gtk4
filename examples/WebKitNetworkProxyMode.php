...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitNetworkProxyMode;

/*
 * Gtk4\WebKitNetworkProxyMode - Enum values used to set the network proxy mode.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitNetworkProxyMode
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitNetworkProxyMode::cases(),
        );
        $label->set_markup("<b>WebKitNetworkProxyMode</b>\n" . implode("\n", $rows));
        return $label;
    },
);
