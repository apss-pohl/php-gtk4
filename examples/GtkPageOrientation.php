...
/*
 * Gtk4\GtkPageOrientation - See also gtk_print_settings_set_orientation().
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkPageOrientation
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            GtkPageOrientation::cases(),
        );
        $label->set_markup("<b>GtkPageOrientation</b>\n" . implode("\n", $rows));
        return $label;
    },
);
