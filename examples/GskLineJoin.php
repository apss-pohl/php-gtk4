...
use Gtk4\GskLineJoin;
use Gtk4\GtkLabel;
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;

/*
 * Gtk4\GskLineJoin - Specifies how to render the junction of two lines when stroking.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GskLineJoin
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $label->set_markup("<b>GskLineJoin</b>\n" . implode("\n", $rows));
        return $label;
    },
);
