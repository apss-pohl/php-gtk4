...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitAutoplayPolicy;

/*
 * Gtk4\WebKitAutoplayPolicy - Enum values used to specify autoplay policies.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitAutoplayPolicy
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitAutoplayPolicy::cases(),
        );
        $label->set_markup("<b>WebKitAutoplayPolicy</b>\n" . implode("\n", $rows));
        return $label;
    },
);
