 ...
 *
 *   bin/php-gtk4 examples/GListStore.php
 */

require __DIR__ . '/bootstrap.php';

Demo::run('GListStore', function (GtkWindow $win): GtkWidget {
    ...
    $steps = [
        ...
        ['remove', function () use ($store, $marker): string {
            ...
            return sprintf('remove(%s) - find() now returns %s', var_export($at, true), var_export($store->find($marker), true));
        }],
