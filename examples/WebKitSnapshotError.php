...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitSnapshotError;

/*
 * Gtk4\WebKitSnapshotError - Enum values used to denote errors happening when creating snapshots of…
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitSnapshotError
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitSnapshotError::cases(),
        );
        $label->set_markup("<b>WebKitSnapshotError</b>\n" . implode("\n", $rows));
        return $label;
    },
);
