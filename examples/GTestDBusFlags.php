 ...
 * 'Generated' section.
 *
 *   bin/php-gtk4 examples/demo.php GTestDBusFlags
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(GTestDBusFlags::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>GTestDBusFlags</b>\n" . implode("\n", $rows));
        return $label;
    },
);
