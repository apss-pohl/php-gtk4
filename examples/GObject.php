 ...
 *
 *   bin/php-gtk4 examples/GObject.php
 */

require __DIR__ . '/bootstrap.php';

Demo::run('GObject', function (GtkWindow $win): GtkWidget {
    /** @var list<string> $log */
    $log = [];
    $label = Demo::label();
    ...
    $id = $win->connect('notify::title', function (GObject $obj, GParamSpec $spec) use ($win, &$log, $render): void {
        $log[] = sprintf(
            '%-14s %-10s -> %s',
            $spec->get_name(),
            $spec->get_value_type(),
