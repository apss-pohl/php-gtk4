 ...
 *
 *   bin/php-gtk4 examples/demo.php GtkFilter
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $filter = new GtkCustomFilter(function (GObject $item) use (&$threshold): bool {
        ...
        Demo::status(sprintf('%s extends %s', $filter::class, get_parent_class($filter)));
