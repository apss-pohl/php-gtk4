 ...
 *
 *   bin/php-gtk4 examples/GtkFilterChange.php
 */

require __DIR__ . '/bootstrap.php';

Demo::run('GtkFilterChange', function (GtkWindow $win): GtkWidget {
    $store = Demo::store();
    $minimum = 1900;
    $filter = new GtkCustomFilter(function ($item) use (&$minimum): bool {
