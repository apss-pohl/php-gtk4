 ...
 *
 *   bin/php-gtk4 examples/GtkAlign.php
 */

require __DIR__ . '/bootstrap.php';

Demo::run('GtkAlign', function (GtkWindow $win): GtkWidget {
    $face = new GtkLabel();
    ...
    $win->set_title('php-gtk4 · GtkAlign — ' . GtkAlign::from(3)->name . ' = GtkAlign::from(3)');
    return $button;
}, 520, 400);
