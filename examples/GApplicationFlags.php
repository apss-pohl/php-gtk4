 ...
 *
 *   bin/php-gtk4 examples/demo.php GApplicationFlags
 */
...
return Demo::page(
    'GApplicationFlags',
    'a bitmask, so a constant class rather than an enum',
    function (GtkWindow $win, GtkApplication $app): GtkWidget {
        // What the harness built this application with, plus one more for the picture.
