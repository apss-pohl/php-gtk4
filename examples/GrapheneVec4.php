...
/*
 * Gtk4\GrapheneVec4 - a vector of 4 components.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php GrapheneVec4
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $render = function () use (&$at, $label): void {
            $a = GrapheneVec4::alloc();
            $b = GrapheneVec4::alloc();
            $a->init(1.0 + $at, 2.0, 3.0, 4.0);
            $b->init(3.0, 4.0, 5.0, 6.0);
            $sum = $a->add($b);
