...
/*
 * Gtk4\WebKitFindOptions - Enum values used to specify search options.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitFindOptions
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        $constants = array_filter(new \ReflectionClass(WebKitFindOptions::class)->getConstants(), 'is_int');
        $label = new GtkLabel();
        $rows = array_map(
        ...
        $label->set_markup("<b>WebKitFindOptions</b>\n" . implode("\n", $rows));
        return $label;
    },
);
