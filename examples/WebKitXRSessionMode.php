...
use Gtk4\GtkWidget;
use Gtk4\GtkWindow;
use Gtk4\WebKitXRSessionMode;

/*
 * Gtk4\WebKitXRSessionMode - Enum values representing the XR session mode.
 *
 ...
 *
 *   bin/php-gtk4 examples/demo.php WebKitXRSessionMode
 */
...
return Demo::page(
    ...
    function (GtkWindow $win): GtkWidget {
        ...
        $rows = array_map(
            ...
            WebKitXRSessionMode::cases(),
        );
        $label->set_markup("<b>WebKitXRSessionMode</b>\n" . implode("\n", $rows));
        return $label;
    },
);
