...
/*
 * Vendored from php-src: build/gen_stub.php (PHP 8.4).
 * Copyright (c) The PHP Group. Licensed under the PHP License, version 3.01
 * (https://www.php.net/license/3_01.txt). Not covered by this repository's
 * MIT LICENSE; local modifications, if any, are noted in gen/README.md.
 */
