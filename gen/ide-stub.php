 ...
 * (stubs/gtk4.stub.php): same declarations and docblocks, but every method
...
$source = __DIR__ . '/../stubs/gtk4.stub.php';
...
$traverser->addVisitor(new class extends NodeVisitorAbstract {
    ...
    {
        if ($node instanceof Stmt\Class_ && $node->name?->toString() === 'GObject') {
...
$header = <<<'PHP'
    ...
    /**
     * php-gtk4 IDE stubs - GENERATED by gen/ide-stub.php from stubs/gtk4.stub.php.
     * Do not edit; edit the .stub.php and run `php gen/ide-stub.php`.
     *
