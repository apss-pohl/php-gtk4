...
$problems = [];
// Generated files carry their comment blocks from gen/gir.php (same stub, same format); the
// generator owns them, so they are neither checked nor rewritten here.
$files = array_filter(
    array_merge(glob($root . '/src/*.cpp') ?: [], glob($root . '/src/*/*.cpp') ?: []),
    static fn(string $f): bool => !str_contains((string) file_get_contents($f), 'GENERATED by gen/gir.php'),
);
sort($files);
